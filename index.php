...
define('CAMPAIGN_ID', "5b2a0af186add4b97949586add3dc116");
define('REQUEST_LIVE_TIME', 3600);
define('ENC_KEY', '8550d4f5af37aa1de8df46a9cc04b7f0');
define('MP_PARAM_NAME', '__ot__sess');
define('NOT_FOUND_TEXT', '<h1>Page not found</h1>');
define('CHECK_MCPROXY', 0);
define('CHECK_MCPROXY_PARAM', 'fc59357446480a123dd0a0d2d30c8e9d');
define('CHECK_MCPROXY_VALUE', 'bf14f12d238431497c4679040bc609b58c5cd876d401b9f6ade757918f1df5fc');
...
function sendRequest($data, $path = 'index') {
    ...
    $data_to_post = array("cmp"=> CAMPAIGN_ID,"headers" => $data,"adapi" => '2.2', "sv" => '6048.3');
